...
st.sidebar.write(f"🐛 DEBUG: selected mode = {mode}")

# --- Schedule & Order Mud ---
if mode == "Schedule & Order Mud":
    st.sidebar.write("🐛 DEBUG: entered Schedule & Order Mud branch")
...
# --- EPO & Tracker ---
    ...
    st.sidebar.write("🐛 DEBUG: entered EPO & Tracker branch")
...
# --- QC Scheduling ---
    ...
    st.sidebar.write("🐛 DEBUG: entered QC Scheduling branch")
...
# --- Homeowner Scheduling ---
    ...
    st.sidebar.write("🐛 DEBUG: entered Homeowner Scheduling branch")
...
# --- Note Taking with LLM Classification ---
    ...
    st.sidebar.write("🐛 DEBUG: entered Note Taking branch")
